...
let referenceBinaries = [ "Yaaf.FSharp.Scripting.dll" ]
// Web site location for the generated documentation
let website = "/Yaaf.FSharp.Scripting"

let githubLink = "http://github.com/matthid/Yaaf.FSharp.Scripting"

// Specify more information about your project
let info =
  [ "project-name", "Yaaf.FSharp.Scripting"
    "project-author", "Matthias Dittrich"
    "project-summary", "A helper library to easily add F# scripts to your application."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Yaaf.FSharp.Scripting" ]
