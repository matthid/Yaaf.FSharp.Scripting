...
let info =
    MsBuildHelper.readMsBuildInfo "Test.Yaaf.FSharp.Scripting.fsproj"
    |> MsBuildHelper.fixIncludes "../../../test/Test.Yaaf.FSharp.Scripting"
let generatorConfig =
 { BuildFileList =
    [ "../../net45/test/Test.Yaaf.FSharp.Scripting/.fsproj",
