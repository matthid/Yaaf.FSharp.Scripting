# Yaaf.FSharp.Scripting implementation documentation 
...
- `Yaaf.FSharp.Scripting`: For one a project to test the building infrastructure, in the future a helper to generate fsproj and csproj files.
