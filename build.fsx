...
let description = "This library builds on top of the FSharp.Compiler.Service library and provides a nice API for F# script integration. It provides APIs to push values into and to get values from scripts."
...
let solutionFile  = "Yaaf.FSharp.Scripting.sln"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/matthid"
